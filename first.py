...
#SubmitButton
update_text = PushButton(app, command=SuccessfulMessage, text="Submit" , grid=[6,1], align="left")

next_text = PushButton(app, command=save_data_to_file, text="Next" , grid=[6,2], align="left")
